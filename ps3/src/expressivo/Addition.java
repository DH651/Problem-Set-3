...
public class Addition extends BinaryOperation {
	...
	} else if (simplifiedRightOperand.equals(simplifiedLeftOperand)) {
	    // Expression + Expression = 2 * Expression
	    return new Multiplication(new Number(2), simplifiedRightOperand);

	} else {

	    return new Addition(simplifiedLeftOperand, simplifiedRightOperand);
	}
    }
